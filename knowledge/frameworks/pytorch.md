...
- ATen / Inductor kernel bodies are out-of-bounds for direct copy. They are
  the right correctness reference but the wrong design template for an
  LLM-serving-specific kernel.
