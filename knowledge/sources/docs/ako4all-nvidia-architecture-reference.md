---
id: doc-ako4all-nvidia-architecture-reference
title: "AKO4ALL NVIDIA Architecture Reference"
...
description: "Distilled local architecture notes from the previous AKO4ALL reference tree; used as background knowledge, not primary PR evidence."
---

# AKO4ALL NVIDIA Architecture Reference

This source page preserves the useful architecture layer from the previous
`knowledge/references/ako4all` tree without restoring the old document dump.
...
## Useful Original Paths

- `knowledge/references/ako4all/nvidia-architecture-reference.md`
- `knowledge/references/ako4all/architectures/sm90-optimization-guide.md`
- `knowledge/references/ako4all/cuda-cpp/sm100-optimization-guide.md`
- `knowledge/references/ako4all/cuda-cpp/sm120-optimization-guide.md`
