...
| Repository | PR guide | CUDA-kernel PRs | Filtered pool |
| --- | --- | ---: | ---: |
| `NVIDIA/cutlass` | [`cutlass.md`](cutlass.md) | 140 | 140 |
| `pytorch/pytorch` | [`pytorch.md`](pytorch.md) | 39 | 39 |
| `sgl-project/sglang` | [`sglang.md`](sglang.md) | 304 | 304 |
| `vllm-project/vllm` | [`vllm.md`](vllm.md) | 297 | 297 |
| `flashinfer-ai/flashinfer` | [`flashinfer.md`](flashinfer.md) | 261 | 261 |
| `deepseek-ai/DeepGEMM` | [`deepgemm.md`](deepgemm.md) | 58 | 58 |
| `NVIDIA/TensorRT-LLM` | [`tensorrt-llm.md`](tensorrt-llm.md) | 348 | 348 |
| `Dao-AILab/flash-attention` | [`flash-attention.md`](flash-attention.md) | 194 | 194 |
| `triton-lang/triton` | [`triton.md`](triton.md) | 92 | 92 |
| `tile-ai/tilelang` | [`tilelang.md`](tilelang.md) | 231 | 231 |
| `Dao-AILab/quack` | [`quack.md`](quack.md) | 26 | 26 |
| `deepseek-ai/TileKernels` | [`tilekernels.md`](tilekernels.md) | 1 | 1 |
| `HazyResearch/ThunderKittens` | [`thunderkittens.md`](thunderkittens.md) | 53 | 53 |
| `NVIDIA/cccl` | [`cccl-cub.md`](cccl-cub.md) | 458 | 458 |
| `NVIDIA/cuda-samples` | [`cuda-samples.md`](cuda-samples.md) | 15 | 15 |
| `NVIDIA/CUDALibrarySamples` | [`cuda-library-samples.md`](cuda-library-samples.md) | 2 | 2 |
| `NVIDIA/cudnn-frontend` | [`cudnn-frontend.md`](cudnn-frontend.md) | 14 | 14 |
| `NVIDIA/nvbench` | [`nvbench.md`](nvbench.md) | 62 | 62 |
| `NVIDIA/cuda-tile` | [`cuda-tile.md`](cuda-tile.md) | 0 | 0 |
| `gpu-mode/reference-kernels` | [`gpu-mode-reference-kernels.md`](gpu-mode-reference-kernels.md) | 31 | 31 |
| `gpu-mode/kernelbot` | [`gpu-mode-kernelbot.md`](gpu-mode-kernelbot.md) | 85 | 85 |
| `gpu-mode/Triton-Puzzles` | [`triton-puzzles.md`](triton-puzzles.md) | 7 | 7 |
| `NVIDIA-developer-blog/code-samples` | [`nvidia-blog-code-samples.md`](nvidia-blog-code-samples.md) | 16 | 16 |
| `leimao/CUDA-GEMM-Optimization` | [`leimao-cuda-gemm.md`](leimao-cuda-gemm.md) | 2 | 2 |
| `siboehm/SGEMM_CUDA` | [`siboehm-sgemm.md`](siboehm-sgemm.md) | 1 | 1 |
| `ColfaxResearch/cutlass-kernels` | [`colfax-cutlass-kernels.md`](colfax-cutlass-kernels.md) | 3 | 3 |
| `ColfaxResearch/cfx-article-src` | [`colfax-article-src.md`](colfax-article-src.md) | 4 | 4 |
...
| `moderngpu/moderngpu` | [`moderngpu.md`](moderngpu.md) | 7 | 7 |
| `huggingface/kernels` | [`huggingface-kernels.md`](huggingface-kernels.md) | 81 | 81 |
| `Tencent/hpc-ops` | [`tencent-hpc-ops.md`](tencent-hpc-ops.md) | 8 | 8 |
