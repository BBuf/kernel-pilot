...
Use FlashInfer as prior art for paged attention, prefix-cache-aware attention,
MLA, sampling, and plan/run Python wrapper patterns.
...
Do not copy FMHA, paged attention, MLA, or sampling kernel bodies.
