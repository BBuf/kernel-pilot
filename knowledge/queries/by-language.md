...
| `blog-colfax-kernel-tutorials` | community-note | [`sources/blogs/colfax-kernel-tutorials.md`](../sources/blogs/colfax-kernel-tutorials.md) | Colfax Kernel Tutorial and Companion Code Map |
| `blog-lei-mao-cuda-gemm` | community-note | [`sources/blogs/lei-mao-cuda-gemm.md`](../sources/blogs/lei-mao-cuda-gemm.md) | Lei Mao CUDA GEMM Optimization Code Map |
...
| `blog-nvidia-cuda-kernel-patterns` | community-note | [`sources/blogs/nvidia-cuda-kernel-patterns.md`](../sources/blogs/nvidia-cuda-kernel-patterns.md) | NVIDIA CUDA Developer Blog Kernel Patterns |
| `blog-simon-boehm-sgemm` | benchmark-blog | [`sources/blogs/simon-boehm-sgemm.md`](../sources/blogs/simon-boehm-sgemm.md) | Simon Boehm SGEMM Optimization Ladder |
| `blog-veitner-cuda-cute` | community-note | [`sources/blogs/veitner-cuda-cute.md`](../sources/blogs/veitner-cuda-cute.md) | Veitner CUDA, CuTe DSL, PTX, and Sequence Kernel Notes |
| `blog-yifan-yang-cuda-matmul` | community-note | [`sources/blogs/yifan-yang-cuda-matmul.md`](../sources/blogs/yifan-yang-cuda-matmul.md) | Yifan Yang CUDA Matmul Roofline and Register Tiling Notes |
...
| `kernel-deepgemm` | kernel | [`wiki/kernels/deepgemm.md`](../wiki/kernels/deepgemm.md) | DeepGEMM — FP8 GEMM with Fine-Grained Scaling |
| `kernel-flashmla` | kernel | [`wiki/kernels/flashmla.md`](../wiki/kernels/flashmla.md) | FlashMLA — Multi-head Latent Attention |
| `kernel-fp8-block-scale-gemm` | kernel | [`wiki/kernels/fp8-block-scale-gemm.md`](../wiki/kernels/fp8-block-scale-gemm.md) | FP8 Block-Scale GEMM |
| `kernel-fused-moe` | kernel | [`wiki/kernels/fused-moe.md`](../wiki/kernels/fused-moe.md) | Fused MoE — FP8 Block-Scale Routing + Dual GEMM |
| `kernel-gated-delta-net` | kernel | [`wiki/kernels/gated-delta-net.md`](../wiki/kernels/gated-delta-net.md) | Gated Delta Net — Linear Attention |
| `kernel-gated-dual-gemm` | kernel | [`wiki/kernels/gated-dual-gemm.md`](../wiki/kernels/gated-dual-gemm.md) | Gated Dual GEMM (Gate-Up + SwiGLU Fusion) |
| `kernel-grouped-gemm` | kernel | [`wiki/kernels/grouped-gemm.md`](../wiki/kernels/grouped-gemm.md) | Grouped GEMM for MoE |
| `kernel-nvfp4-gemm` | kernel | [`wiki/kernels/nvfp4-gemm.md`](../wiki/kernels/nvfp4-gemm.md) | NVFP4 GEMM — 4-bit Floating Point Matrix Multiply |
| `kernel-nvfp4-gemv` | kernel | [`wiki/kernels/nvfp4-gemv.md`](../wiki/kernels/nvfp4-gemv.md) | NVFP4 Batched GEMV |
| `kernel-sparse-mla` | kernel | [`wiki/kernels/sparse-mla.md`](../wiki/kernels/sparse-mla.md) | Sparse MLA (DeepSeek V3.2) |
...
| `pr-vllm-7174` | upstream-code | [`sources/prs/vllm/PR-7174.md`](../sources/prs/vllm/PR-7174.md) | [Kernel] (1/N) Machete - Hopper Optimized Mixed Precision Linear Kernel  |
| `pr-vllm-7701` | upstream-code | [`sources/prs/vllm/PR-7701.md`](../sources/prs/vllm/PR-7701.md) | [Kernel] (2/N) Machete - Integrate into CompressedTensorsWNA16 and GPTQMarlin |
| `kernel-flash-attention-4` | kernel | [`wiki/kernels/flash-attention-4.md`](../wiki/kernels/flash-attention-4.md) | FlashAttention-4 |
| `kernel-fp8-block-scale-gemm` | kernel | [`wiki/kernels/fp8-block-scale-gemm.md`](../wiki/kernels/fp8-block-scale-gemm.md) | FP8 Block-Scale GEMM |
| `kernel-fused-moe` | kernel | [`wiki/kernels/fused-moe.md`](../wiki/kernels/fused-moe.md) | Fused MoE — FP8 Block-Scale Routing + Dual GEMM |
| `kernel-gated-dual-gemm` | kernel | [`wiki/kernels/gated-dual-gemm.md`](../wiki/kernels/gated-dual-gemm.md) | Gated Dual GEMM (Gate-Up + SwiGLU Fusion) |
| `kernel-grouped-gemm` | kernel | [`wiki/kernels/grouped-gemm.md`](../wiki/kernels/grouped-gemm.md) | Grouped GEMM for MoE |
...
| `kernel-fused-moe` | kernel | [`wiki/kernels/fused-moe.md`](../wiki/kernels/fused-moe.md) | Fused MoE — FP8 Block-Scale Routing + Dual GEMM |
| `kernel-gated-delta-net` | kernel | [`wiki/kernels/gated-delta-net.md`](../wiki/kernels/gated-delta-net.md) | Gated Delta Net — Linear Attention |
| `kernel-nsa` | kernel | [`wiki/kernels/nsa.md`](../wiki/kernels/nsa.md) | Native Sparse Attention (NSA) |
